...
export async function create(prestacaoServico: PrestacaoServicoDBType) {
     try {
...
export async function getAll() {
    ...
    export async function update(id: string, prestacaoServico: PrestacaoServicoDBType) {
        try {
            const [rows] = await db.execute(
    ...
    export async function  deletePrestacaoServicos(id: string) {
        try {
